...
function move(ev) {
    ...
    if (dragElement % num < (num - 1) && cells[dropElement].x == 100 && cells[dropElement].y == 100) {
        ...
        if (cells[dragElement + 1].x == 100 && cells[dragElement + 1].y == 100) {
            ...
            document.getElementById("img" + dropElement).style.backgroundPosition = cells[dragElement].x + "% " + cells[dropElement].y + "% ";
    ...
    //handling down moves
    if (dragElement < ((num * num) - num) && cells[dropElement].x == 100 && cells[dropElement].y == 100) {
    ...
    //handling up moves
    if (dragElement < (num * num) && dragElement > num && cells[dropElement].x == 100 && cells[dropElement].y == 100) {
    ...
    //handling left moves
    if (dragElement % num > 1 && cells[dropElement].x == 100 && cells[dropElement].y == 100) {
