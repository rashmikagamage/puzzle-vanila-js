...
function move(ev) {
    ...
    //handling down moves
    if (dragElement < ((num * num) - num) && cells[dropElement].xPosition == -1) {
        if (cells[dragElement + num].xPosition == -1) {
            document.getElementById("img" + dragElement).style.backgroundImage = "";
            document.getElementById("img" + dragElement).style.backgroundColor = "white";
            document.getElementById("img" + dropElement).style.backgroundImage = "url('./chess.jpg.')";
            document.getElementById("img" + dropElement).style.backgroundPosition = cells[dragElement].x + "% " + cells[dragElement].y + "% ";
    ...
    //handling up moves
    if (dragElement < (num * num) && dragElement > num - 1 && cells[dropElement].xPosition == -1) {
    ...
    //handling left moves
    if (dragElement % num > 0 && cells[dropElement].xPosition == -1) {
        if (cells[dragElement - 1].xPosition == -1) {
            document.getElementById("img" + dragElement).style.backgroundImage = "";
            document.getElementById("img" + dragElement).style.backgroundColor = "white";
            document.getElementById("img" + dropElement).style.backgroundImage = "url('./chess.jpg.')";
            document.getElementById("img" + dropElement).style.backgroundPosition = cells[dragElement].x + "% " + cells[dragElement].y + "% ";
