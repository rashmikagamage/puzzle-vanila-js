...
function move(ev) {
    ...
    if (dragElement % num < (num - 1) && cells[dropElement].x == 100 && cells[dropElement].y == 100) {
        ...
        if (cells[dragElement + 1].x == 100 && cells[dragElement + 1].y == 100) {
            ...
            document.getElementById("img" + dragElement).style.backgroundPosition = cells[dropElement].x + "% " + cells[dropElement].y + "%";
            document.getElementById("img" + dropElement).style.backgroundPosition = cells[dragElement].x + "% " + cells[dragElements].y + "%";
